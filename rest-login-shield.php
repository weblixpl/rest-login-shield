...
require_once RLS_PATH . 'includes/class-login-honeypot.php';
...
// Auto-update via self-hosted JSON metadata served from GitHub Pages.
// This avoids GitHub API rate limits (60/h per IP for unauthenticated callers)
// that block update checks for shared-hosting clients. Metadata file is
// regenerated by CI on every release; download_url points at the release asset.
if (file_exists(RLS_PATH . 'vendor/plugin-update-checker/plugin-update-checker.php')) {
    ...
    $rls_updater = YahnisElsts\PluginUpdateChecker\v5\PucFactory::buildUpdateChecker(
        'https://weblixpl.github.io/rest-login-shield/metadata.json',
        __FILE__,
        'rest-login-shield'
    );
}
